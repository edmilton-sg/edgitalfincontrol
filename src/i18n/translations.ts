...
export const translations = {
  "pt-BR": {
    ...
    // Employees
    newEmployee: "Novo Prestador",
    editEmployee: "Editar Prestador",
    employeeName: "Nome",
    employeePosition: "Cargo",
    employeeDepartment: "Departamento",
    employeeSalary: "Salário",
    employeeHireDate: "Data de Admissão",
    employeeTerminationDate: "Data de Demissão",
    employeeActive: "Ativo",
    employeeTerminated: "Desligado",
    employeeDetails: "Detalhes do Prestador",
    employeeSaved: "Prestador salvo!",
    searchEmployee: "Buscar prestador...",
    allEmployees: "Todos os Prestadores",
    payrollTitle: "Gerar Folha de Pagamento",
    processPayroll: "Processar Folha",
    payrollAdditions: "Adicionais",
    payrollDeductions: "Outros Descontos",
    payrollProcessed: "Folha processada!",
    generateAllPayroll: "Gerar Folha de Todos",
    generateAllPayrollConfirm: "Gerar folha do mês atual para todos os funcionários ativos?",
    payrollBulkGenerated: "{count} folha(s) geradas",
    payrollBulkSkipped: "Nenhuma folha nova gerada (já existem para o mês atual)",
    payrollExpense: "Folha de Pagamento",
    managedByPayrollModule: "Gerenciado pelo módulo de Prestadores",
    ...
    archiveCard: "Arquivar",
    unarchiveCard: "Desarquivar",
    archivedCards: "Cartões Arquivados",
    archiveOrDelete: "Arquivar ou Excluir?",
    archiveDescription: "Manter o cartão e seus registros como histórico, sem exibir entre os ativos.",
    deleteAllDescription: "Remover permanentemente o cartão, todas as transações, anexos e despesas vinculadas.",
    cardArchived: "Cartão arquivado!",
    cardUnarchived: "Cartão reativado!",
    deleteCardDetails: "Este cartão possui {transactions} transação(ões), {attachments} anexo(s) e {expenses} despesa(s) vinculada(s).",
    deleteTransactionDetails: "A transação, {attachments} anexo(s) e a despesa vinculada serão removidos.",
    deletePayrollDetails: "O pagamento, {attachments} anexo(s) e a despesa vinculada serão removidos.",
    deleteProLaboreDetails: "O registro, {attachments} anexo(s) e a despesa vinculada serão removidos.",
    deleteRevenueDetails: "A receita e {attachments} anexo(s) serão removidos permanentemente.",
    deleteExpenseDetails: "A despesa e {attachments} anexo(s) serão removidos permanentemente.",
    deleteEmployeeDetails: "O prestador e todos os registros de folha vinculados serão removidos.",
  ...
  en: {
    ...
    employeeTerminationDate: "Termination Date",
    ...
    payrollAdditions: "Additions",
    payrollDeductions: "Other Deductions",
    payrollProcessed: "Payroll processed!",
    generateAllPayroll: "Generate All Payroll",
    generateAllPayrollConfirm: "Generate current month payroll for all active employees?",
    payrollBulkGenerated: "{count} payroll(s) generated",
    payrollBulkSkipped: "No new payroll generated (already exist for current month)",
